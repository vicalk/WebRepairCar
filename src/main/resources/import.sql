...
insert into repairs(REPAIR_DATE,REPAIR_TIME,REPAIR_STATUS,REPAIR_TYPE,REPAIR_COST,VEHICLE_ID) values ('11/11/2017','11:15','completed','small','500','1');
insert into repairs(REPAIR_DATE,REPAIR_TIME,REPAIR_STATUS,REPAIR_TYPE,REPAIR_COST,VEHICLE_ID) values ('10/11/2017','09:30','in progress','big','1000','2');