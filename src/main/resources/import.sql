...
insert into repairs(REPAIR_DATE,REPAIR_STATUS,REPAIR_TYPE,REPAIR_COST,VEHICLE_ID) values ('11-11-2017','completed','small','1');
insert into repairs(REPAIR_DATE,REPAIR_STATUS,REPAIR_TYPE,REPAIR_COST,VEHICLE_ID) values ('10-11-2017','in progress','big','2');