...
insert into repairs(REPAIR_DATE,REPAIR_TIME,REPAIR_STATUS,REPAIR_TYPE,REPAIR_COST,VEHICLE_ID) values ('11/10/2017','11:15','Completed','Small','500','1');
insert into repairs(REPAIR_DATE,REPAIR_TIME,REPAIR_STATUS,REPAIR_TYPE,REPAIR_COST,VEHICLE_ID) values ('11/10/2017','09:30','Completed','Big','1000','2');
insert into repairs(REPAIR_DATE,REPAIR_TIME,REPAIR_STATUS,REPAIR_TYPE,REPAIR_COST,VEHICLE_ID) values ('27/10/2017','11:15','In_Progress','Small','500','1');
insert into repairs(REPAIR_DATE,REPAIR_TIME,REPAIR_STATUS,REPAIR_TYPE,REPAIR_COST,VEHICLE_ID) values ('27/10/2017','12:30','In_Progress','Big','1000','2');
insert into repairs(REPAIR_DATE,REPAIR_TIME,REPAIR_STATUS,REPAIR_TYPE,REPAIR_COST,VEHICLE_ID) values ('27/10/2017','13:15','On_Hold','Small','500','3');
insert into repairs(REPAIR_DATE,REPAIR_TIME,REPAIR_STATUS,REPAIR_TYPE,REPAIR_COST,VEHICLE_ID) values ('27/10/2017','15:30','On_Hold','Big','1000','4');