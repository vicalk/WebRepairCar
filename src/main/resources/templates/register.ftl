      ...
      <li class="dropdown">
       ...
       <div class="side">
        <form action="/register" method="post" id="registrationForm" name="registrationForm">
            ...
            <input type="text" id="TaxNum" name="afm" placeholder="Type a unique tax number.." required><br>

           <label for="fname">First name</label>
            <input type="text" id="fname" name="firstname" placeholder="Type first name.." required>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>

           <label for="lname">Last name</label>
            <input type="text" id="lname" name="lastname" placeholder="Type last name.." required><br>

           <label for="TaxNum">e-mail</label>
            <input type="text" id="email" name="email" placeholder="Type e-mail.." required>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
           ...
           <label for="userpass">User password</label>
            <input type="text" id="UserP" name="password" placeholder="Set new password.." required>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
